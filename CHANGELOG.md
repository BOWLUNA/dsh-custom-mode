...
Seven suites with **301 checks** in total, most of them filling the coverage that mattered most and
was missing:
...
real shipped text rather than a hand-made fixture), runs the seven suites, and checks source-file
