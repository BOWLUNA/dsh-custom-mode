...
| --- | --- | --- |
| `1.9.8` (current release) | `0.1.5-rc.2` (latest stable) **and** `0.1.6-alpha.2` (latest preview) | **Supported** — the declared range is `>=0.1.5-rc.2 <0.2.0-0`, and CI installs and runs the whole suite against both lines |
