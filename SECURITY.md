...
| --- | --- | --- |
| `1.9.10` (current release) | `0.1.5-rc.2` (latest stable) **and** the preview line (`0.1.6-alpha.2`, `0.1.7-alpha.*`) | **Supported** — the declared range is `>=0.1.5-rc.2 <0.2.0-0 \|\| >=0.1.6-alpha.1 <0.2.0-0 \|\| >=0.1.7-alpha.1 <0.2.0-0`, and CI installs and runs the whole suite against the stable line and both preview lines |
| `1.9.9` | the same | Supported (superseded) |
