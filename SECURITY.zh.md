...
| 插件版本 | DSH 版本 | 状态 |
| --- | --- | --- |
| `1.9.0`（当前发布版本） | `0.1.5-rc.2`（最新稳定版）**与** `0.1.6-alpha.2`（最新预览版） | **支持** —— 声明范围是 `>=0.1.5-rc.2 <0.2.0-0`，CI 对两条线各安装一次并各跑一遍完整测试 |
| `1.0.0`–`1.0.6` | `0.1.6-alpha.2` | 支持（已被取代） |
| `1.0.0` | `0.1.6-alpha.2` | **支持（当前开发与验证目标）** |
| `0.1.6-alpha.2` | `0.1.6-alpha.2` | **支持（当前开发与验证目标）** |
